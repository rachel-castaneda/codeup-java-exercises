...
//        diceRolling();
    ...
    public static void highLow() {
        ...
        System.out.print("let's play a guessing game! guess what number i'm thinking of: ");
        guess = getInteger(1, 100);
        for (int guesses = 1; guesses <= 10 && guess != secret; guess = getInteger(1, 100)) {
            if (guess < secret) System.out.println("higher");
            else if (guess > secret) System.out.println("lower");
            else if (guess == secret) System.out.println("good guess! you win!");
